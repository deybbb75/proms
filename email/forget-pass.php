...
$email = new \SendinBlue\Client\Model\SendSmtpEmail([
    'to' => [['email' => $_SESSION['proms']['reset_email']['email'], 'name' => $_SESSION['proms']['reset_email']['name']]],
    'templateId' => 1,
    'params' => [
        'link_url' => $GLOBALS['INF_CONFIG']['sitehost']. '/reset-pass.php?token=' . $_SESSION['proms']['reset_email']['token'],
    ]
]);
