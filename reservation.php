...
<main class="main">
    ...
    <div class="page-title light-background">
        ...
        <h1 class="mb-2 mb-lg-0">Reservation Form</h1>
        </div>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="reservation-form-wrapper">
                    ...
                    <div class="reservation-header text-center mb-5" data-aos="fade-up" data-aos-delay="200">
                    <h2>Reserve Your Dream Program</h2>
                    ...
                    <form class="reservation-form" data-aos="fade-up" data-aos-delay="300">
